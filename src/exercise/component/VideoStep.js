...
export default class VideoStep extends React.Component<Object, Object> {
    ...
    render(): Element<*> {
        ...
        return <Box className="VideoStep">
            <VideoPlayer className="VideoStep_videoPlayer" videoRef={(VideoPlayer: *) => { this.videoRef = VideoPlayer; }} src={file} onChange={this.onChange} complete={this.state.complete} >s
